...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "http://www.presstab.pw/phpexplorer/SCIFI/tx.php?tx=%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "http://www.presstab.pw/phpexplorer/SCIFI/tx.php?tx=%s").toString();
