    ...
    coinControl(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a UnitedSciFi address (e.g. 3LX4HrM2vMa9rt8zDiutWvcvAi1894uRxj)"));
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    foreach(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        { 
    #if QT_VERSION < 0x050000 
        formatted.append(tr("<b>%1</b> in %4 blocks of %5 SCIFI each to %2 (%3)?").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::BTC, rcp.amount),  
            Qt::escape(rcp.label),  
            rcp.address,  
