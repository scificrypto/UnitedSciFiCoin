...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("SCIFI");
    case mBTC: return QString("mSCIFI");
    case uBTC: return QString::fromUtf8("μSCIFI");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("UnitedSciFis"));
    case mBTC: return QString(QObject::tr("Milli-UnitedSciFis (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-UnitedSciFis (1 / 1,000,000)"));
    default: return QString("???");
    }
}
