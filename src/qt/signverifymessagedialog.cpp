    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a UnitedSciFi address (e.g. 3LX4HrM2vMa9rt8zDiutWvcvAi1894uRxj)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a UnitedSciFi address (e.g. 3LX4HrM2vMa9rt8zDiutWvcvAi1894uRxj)"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter UnitedSciFi signature"));
#endif
